...
export function MenuDialog2({ open, onOpenChange, onSave, editData, showBuyNow, hideDescription }: MenuDialogProps) {
      ...
      <DialogContent className="w-[90vw] lg:max-w-3xl rounded-md max-h-[90vh] overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
        ...
        <div className="grid gap-6 py-4">
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor="name" className="text-sm font-medium">Heading</Label>
            <Input
              id="name"
          ...
          {/* Buy Now Link (Conditional) */}
          {showBuyNow && (
            <div className="flex flex-col gap-2">
              <Label htmlFor="buyNowLink" className="text-sm font-medium">Buy Now Link</Label>
              <Input
                id="buyNowLink"
          ...
          {!hideDescription && ( // Conditional rendering for description
            <div className="flex flex-col gap-2">
